...
public class DataBaseHelper extends SQLiteOpenHelper {
    ...
    private static String DB_PATH = "/data/data/com.californiatrafficcam.app/databases/";

    private static String DB_NAME = "calidata.db";
    ...
    // table name
    private static final String TABLE_CAM = "calicamdata";
...
//Close the streams
    ...
    ArrayList<CamData> getCamData() {

        CamData camData;
        Cursor cursor;
        ArrayList<CamData> items = new ArrayList<CamData>();

        // 1. build the query
        String query = "SELECT  * FROM " + TABLE_CAM;
        ...
        if (cursor.getCount() != 0) {
            ...
            while (count != 0) {
                camData = new CamData();
                camData.setID(Integer.parseInt(cursor.getString(0)));
